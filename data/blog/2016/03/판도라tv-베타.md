...
(function() {
    ...
    var loadInjVideo = function() {
        var html = ['<div id="inj-controller" style="color:#aaa;">',
            '<div>',
        ...
        jQuery(window).keydown(function(e) {
            ...
            if (0) {
                ...
                return false;
            } else if (!e.ctrlKey && e.keyCode==70) { //F
                if (isFull) {
        ...
        var getSrcTimer = setInterval(function() {
            if (video.src!='') {
                ...
                var cmdX64 = '"C:\\Program Files (x86)\\DAUM\\PotPlayer\\PotPlayerMini.exe" "'+video.src+'"';
