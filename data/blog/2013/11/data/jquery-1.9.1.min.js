  ...
  ;(b.fn = b.prototype =
    ...
    b.extend({
      ...
      makeArray: function (e, t) {
        var n = t || []
        return (
          null != e && (M(Object(e)) ? b.merge(n, 'string' == typeof e ? [e] : e) : d.call(n, e)), n
        )
      },
      ...
      if (u)
        for (t = (e || '').match(w) || []; s > a; a++)
          if (
            ((n = this[a]),
            (r =
              1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(X, ' ') : ' ')))
          ) {
            o = 0
      ...
      ((I = b.valHooks.button =
        {
          get: function (e, n) {
            var r = e.getAttributeNode(n)
            return r &&
              ('id' === n || 'name' === n || 'coords' === n ? '' !== r.value : r.specified)
              ? r.value
              : t
          },
          set: function (e, n, r) {
  ...
  ;(b.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (m && (c = m.events)) {
        ...
        while (l--)
          if (
            ((s = rt.exec(t[l]) || []), (d = g = s[1]), (h = (s[2] || '').split('.').sort()), d)
          ) {
            ;(p = b.event.special[d] || {}),
                  ...
                  (at(function (e) {
                    ;(e.innerHTML = "<select><option selected=''></option></select>"),
                      e.querySelectorAll('[selected]').length ||
                        h.push(
                          '\\[' + _ + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'
                        ),
    ...
    b.fn.extend({
      ...
      domManip: function (e, n, r) {
        ...
        if (
          ...
          for (
            n = n && b.nodeName(i, 'tr'), s = b.map(Ot(l, 'script'), Ht), a = s.length;
            p > c;
            c++
          )
            (o = l),
  ...
  b.ajaxSetup({
    ...
    b.ajaxPrefilter('json jsonp', function (n, r, i) {
      ...
      return u || 'jsonp' === n.dataTypes[0]
        ? ((o = n.jsonpCallback =
            b.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
          u
