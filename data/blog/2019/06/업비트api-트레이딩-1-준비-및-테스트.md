...
[업비트](https://upbit.com/) **\[마이페이지->Open API 관리\]**에서 API키를 발급받는다.

[![](images/upbit_mypage.png)](http://note.heyo.me/wp-content/uploads/2019/06/upbit_mypage.png)

혹시모르니 **출금기능을 해제하고 IP설정을 꼭 하도록하자.**

**\[발급받기\]**를 클릭하면 나오는 `secret key`와 `access key`를 따로 적어둔다.

## API 모듈

[업비트API문서](https://docs.upbit.com/v1.0.3/) REST API 를 참고하여 만들었다.
